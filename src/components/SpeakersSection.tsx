...
const speakers: Speaker[] = [
  ...
  { name: "Mladen Pejković", title: "Senior Executive Director, Transformation & ICT", company: "Atlantic Grupa", photo: speakerMladenPejkovic, photoPosition: "center center", photoScale: 1.0 },
