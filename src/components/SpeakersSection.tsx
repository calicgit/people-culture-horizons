...
const speakers: Speaker[] = [
  ...
  { name: "Sanja Škrinjar", title: "Human Resources Consultant", company: "DeeP Project", photo: speakerSanjaSkrinjar, photoPosition: "center 18%", bioKey: "speakers.bio.sanja_skrinjar" },
];
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex justify-center mb-10">
          <div className="inline-flex items-center gap-4 rounded-2xl border-2 border-accent/40 bg-gradient-to-r from-accent/10 via-accent/5 to-transparent px-5 py-3 shadow-elevated">
            <div className="flex-shrink-0 w-28 h-28 rounded-full overflow-hidden ring-2 ring-accent/40 bg-muted">
              <img
                src={hostAntonija}
