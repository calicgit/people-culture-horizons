...
const speakers: Speaker[] = [
  { name: "Ivan Bešlić", title: "Co-founder & CSO", company: "Sofascore" },
  ...
  { name: "Ivan Zubak", title: "CEO", company: "Zubak Grupa", photo: speakerIvanZubak, photoPosition: "62% 15%", photoScale: 1.0, bioKey: "speakers.bio.ivan_zubak" },
