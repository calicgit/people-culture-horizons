...
const speakers: Speaker[] = [
  ...
  { name: "Sanja Škrinjar", title: "Human Resources Consultant", company: "DeeP Project", photo: speakerSanjaSkrinjar, photoPosition: "center 12%", bioKey: "speakers.bio.sanja_skrinjar" },
];
