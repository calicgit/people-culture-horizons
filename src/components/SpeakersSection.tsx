...
const speakers: Speaker[] = [
  ...
  { name: "Mladen Pejković", title: "Senior Executive Director, Transformation & ICT", company: "Atlantic Grupa", photo: speakerMladenPejkovic, photoPosition: "center 35%", photoScale: 1.0 },
