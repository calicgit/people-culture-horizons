...
const translations: Record<Language, Record<string, string>> = {
  hr: {
    ...
    "speakers.bio.ingrid_tena_grgic": "Nakon završetka studija psihologije, karijeru započinje u IT sektoru, gdje stječe bogato iskustvo u ljudskim potencijalima, s naglaskom na selekciju, razvoj talenata i organizacijsku kulturu. Radila je u različitim poslovnim okruženjima, od startupa do velikih korporacija, gdje je sudjelovala u ključnim HR inicijativama, uključujući organizacijska spajanja.\n\nNjezin rad obuhvaća savjetovanje menadžera, podršku zaposlenicima, unaprjeđenje radnog okruženja s ciljem povećanja angažmana i zadovoljstva zaposlenika, s posebnim naglaskom na unaprjeđenje organizacijske kulture. Stalno radi na usavršavanju kroz daljnje certifikacije i edukacije.",
    "speakers.bio.romina_ivancic": "Romina Ivančić je poslovno orijentirana HR liderica s više od 15 godina iskustva na sjecištu people strategije i poslovnih rezultata. Tijekom karijere obnašala je vodeće uloge u ljudskim resursima i komercijalnim funkcijama, gdje je u bliskoj suradnji s upravama gradila organizacije visokih performansi te povezivala razvoj ljudi s mjerljivim poslovnim učinkom.\n\nKao ravnateljica Poliklinike za zaštitu djece i mladih Grada Zagreba donosi jedinstvenu perspektivu koja spaja korporativnu disciplinu i javni sektor, s fokusom na strateško upravljanje, razvoj sustava i operativnu izvrsnost.\n\nSuosnivačica je People & Culture Huba, gdje je zadužena za područja talent managementa, succession planninga te learning & developmenta, s ciljem jačanja HR-a kao funkcije koja izravno doprinosi poslovnim rezultatima. Uz to, aktivno je uključena u širu poslovnu zajednicu te usmjerena na primjenu svog iskustva u različitim organizacijskim i poslovnim kontekstima, osobito u područjima razvoja ljudi, organizacije i poslovne učinkovitosti.",
    "speakers.bio.borna_loncar": "Psihologinja koja je doktorski studij završila na Sveučilištu Nottingham Trent (obrana rada u tijeku), usmjerenim na istraživanje negativnih iskustava u djetinjstvu, traume, psihopatije i psihopatologije, s naglaskom na razvojne obrasce i neurokognitivne procese.\n\nU radu se bavi preciznim mjerenjem i statističkom analizom složenih psiholoških mehanizama koji oblikuju osobnost i funkcioniranje pojedinaca. Psihološke uvide povezuje s analitičkim pristupom u oblikovanju evidence-based HR rješenja, s fokusom na podatke, sustave i dugoročnu promjenu.\n\nU DeeP Projectu sudjeluje na projektima organizacijskog razvoja i razvoja People & Culture alata, gdje znanstvene metode i analitički pristup prevodi u primjenjiva rješenja za organizacije.",
  ...
  en: {
    ...
    // Speakers
     ...
     "speakers.subtitle": "",
      ...
      "speakers.bio.ingrid_tena_grgic": "After graduating in psychology, she began her career in the IT sector, where she gained extensive experience in human resources, with an emphasis on selection, talent development and organizational culture. She has worked in a variety of business environments, from startups to large corporations, taking part in key HR initiatives, including organizational mergers.\n\nHer work includes advising managers, supporting employees and improving the work environment with the goal of increasing employee engagement and satisfaction, with particular focus on advancing organizational culture. She continuously develops through further certifications and education.",
      "speakers.bio.romina_ivancic": "Romina Ivančić is a business-oriented HR leader with more than 15 years of experience at the intersection of people strategy and business results. Throughout her career, she has held leadership roles in human resources and commercial functions, working closely with executive boards to build high-performing organizations and connect people development with measurable business impact.\n\nAs Director of the Polyclinic for the Protection of Children and Youth of the City of Zagreb, she brings a unique perspective that combines corporate discipline and the public sector, with a focus on strategic management, systems development and operational excellence.\n\nShe is a co-founder of the People & Culture Hub, where she leads talent management, succession planning and learning & development, aiming to strengthen HR as a function that directly contributes to business results. She is also actively involved in the broader business community and focused on applying her experience across diverse organizational and business contexts, particularly in the areas of people development, organization and business effectiveness.",
      "speakers.bio.borna_loncar": "Psychologist who completed her doctoral studies at Nottingham Trent University (thesis defence in progress), focused on research into adverse childhood experiences, trauma, psychopathy and psychopathology, with an emphasis on developmental patterns and neurocognitive processes.\n\nHer work involves precise measurement and statistical analysis of the complex psychological mechanisms that shape personality and individual functioning. She connects psychological insights with an analytical approach to designing evidence-based HR solutions, focused on data, systems and long-term change.\n\nAt DeeP Project she takes part in organisational development projects and the development of People & Culture tools, translating scientific methods and an analytical approach into applicable solutions for organisations.",
