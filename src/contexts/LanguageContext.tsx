...
const translations: Record<Language, Record<string, string>> = {
  hr: {
    ...
    "topics.subtitle": "",
    "topics.foundations.title": "Temelji (struktura, odgovornost)",
    ...
    "topics.functioning.title": "Funkcioniranje (HR, change)",
    ...
    "topics.results.title": "Rezultati (plaće, produktivnost)",
    ...
    "topics.people.title": "Ljudi (ponašanje, razvoj)",
    ...
    "topics.future.title": "Budućnost (AI, regulativa)",
  ...
  en: {
    ...
    "topics.subtitle": "",
    "topics.foundations.title": "Foundations (structure, responsibility)",
    ...
    "topics.functioning.title": "Functioning (HR, change)",
    ...
    "topics.future.title": "Future (AI, regulation)",
