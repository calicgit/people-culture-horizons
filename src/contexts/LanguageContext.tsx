...
const translations: Record<Language, Record<string, string>> = {
  hr: {
    ...
    "agenda.d1.s3.title": "Keynote predavanje: Kako organizacije donose odluke kada se pravila igre mijenjaju",
    "agenda.d1.s4.title": "Keynote panel: Kad pravila više ne vrijede – Igraju li organizacije i dalje staru igru? Powered by Greco",
    "agenda.d1.s5.title": "Pauza za kavu",
    "agenda.d1.s6.title": "Predavanje: Rast ne ubija organizacije. Nejasne odluke, da.",
    "agenda.d1.s7.title": "Panel: Zašto organizacije ne provedu odluke koje same donesu?",
    "agenda.d1.s8.title": "Ručak",
    "agenda.d1.s9.title": "Predavanje: Rastu plaće. Raste li vrijednost?",
    "agenda.d1.s10.title": "Panel: Ako razumijemo problem, zašto ga onda ne rješavamo?",
    "agenda.d1.s11.title": "Pauza za kavu",
    "agenda.d1.s12.title": "Predavanje: Jesmo li počeli učiti ljude stvari koje im ne koriste?",
    "agenda.d1.s13.title": "Panel: Zašto razvoj ljudi ne donosi poslovnu vrijednost?",
    // Day 2 sessions
  ...
  en: {
    ...
    "agenda.d1.s3.title": "Keynote: How organisations make decisions when the rules of the game change",
    "agenda.d1.s4.title": "Keynote panel: When the rules no longer apply – Are organisations still playing the old game? Powered by Greco",
    "agenda.d1.s5.title": "Coffee break",
    "agenda.d1.s6.title": "Talk: Growth doesn't kill organisations. Unclear decisions do.",
    "agenda.d1.s7.title": "Panel: Why don't organisations implement the decisions they make themselves?",
    "agenda.d1.s8.title": "Lunch",
    "agenda.d1.s9.title": "Talk: Salaries are rising. Is value rising too?",
    "agenda.d1.s10.title": "Panel: If we understand the problem, why aren't we solving it?",
    "agenda.d1.s11.title": "Coffee break",
    "agenda.d1.s12.title": "Talk: Have we started teaching people things that don't help them?",
    "agenda.d1.s13.title": "Panel: Why doesn't people development deliver business value?",
    // Day 2
