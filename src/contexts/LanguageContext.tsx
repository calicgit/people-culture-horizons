...
const translations: Record<Language, Record<string, string>> = {
  ...
  en: {
    ...
    "topics.foundations.desc": "Structure, responsibility",
    "topics.functioning.title": "Functioning",
    "topics.functioning.desc": "HR, change",
    "topics.results.title": "Results",
    "topics.results.desc": "Salaries, productivity",
    "topics.people.title": "People",
    "topics.people.desc": "Behaviour, development",
    "topics.future.title": "Future",
    "topics.future.desc": "AI, regulation",
